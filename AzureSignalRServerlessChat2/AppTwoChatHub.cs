...
namespace AzureSignalRServerlessChat
{
    public class AppTwoChatHub : ServerlessHub
    {
        ...
        public SignalRConnectionInfo Negotiate([HttpTrigger(AuthorizationLevel.Anonymous)] HttpRequest req)
        {
            ...
            return Negotiate(
                claims.First(c => c.Type == ClaimTypes.NameIdentifier || c.Type == "nameid").Value,
                claims
            );
        }
        ...
        {
            await Clients.All.SendAsync(NewMessageTarget, new NewMessage(invocationContext, message + $". HUB : {invocationContext.Hub}"));
